...
export const getTask=()=>(dispatch)=>{
    ...
    return axios.get("http://localhost:3000/tasks").then((r)=>{
...
export const updateTask=(id,payload)=>(dispatch)=>{
    ...
    return axios.patch(`http://localhost:3000/tasks/${id}`,payload).then((r)=>{
...
export const addTask=(payload)=>(dispatch)=>{
    ...
    return axios.post(`http://localhost:3000/tasks`,payload).then((r)=>{
